...
(define (means ton)
  (letrec*
    ...
    (values (mean values values)
            (mean exp log)
            (mean / /))))
(test-values '(27 9.728 1800/497) (means '(8 5 99 1 22)))

(test-values '(5 7) (exact-integer-sqrt 32))
...
(test-values `(1180591620717411303424 0) (exact-integer-sqrt (expt 2 140)))
...
; BROKEN - requires custom syntax-rules ellipses
...
; BROKEN - requires custom ellipses
;(let ()
...
;; BROKEN - need to pipe through env variables
